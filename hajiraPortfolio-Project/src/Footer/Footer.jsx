                ...
                <div className={styles.footerContainer}>
                    ...
                    <div className={styles.footerNav}>
                        <div className={active === 'Home' ? styles.activeNav : styles.notActiveNav}>
                            <h1><Link to="/" style={{ color: 'inherit', textDecoration: 'none' }}>Home</Link></h1>
                        </div>

                        <div className={active === "Product" ? styles.activeNav : styles.notActiveNav}>
                            <h1><Link to="/product" style={{ color: 'inherit', textDecoration: 'none' }}>Product</Link></h1>
                        </div>

                        <div className={active === 'Contact' ? styles.activeNav : styles.notActiveNav}>
                            <h1><a href="mailto:workwithhajira@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>Contact</a></h1>
                        </div>
                    </div>
